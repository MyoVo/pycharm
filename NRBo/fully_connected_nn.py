...
def optimize_nn_params(X_train, y_train, N, MaxIt):
    ...
    _, best_params, best_score = NRBO(N, MaxIt, LB, UB, dim, nn_fobj, "Neural Network Model", X_train, y_train)
